        ...
        <div className="collapse navbar-collapse" id="navbarTogglerDemo01">
          ...
          <form className="form-inline my-2 my-lg-0">
            <input
              ...
              aria-label="Search"
              // Removed the width style to allow responsiveness
            />
            <button
              className="btn btn-secondary my-2 my-sm-0 rounded-circle"
              type="submit"
            >
              <svg
          ...
          <ul className="navbar-nav ml-auto mt-1 mt-lg-0">
            <li className="nav-item">
              <button
                className="nav-link text-secondary border border-white"
                style={{
                  marginLeft: '10px',
                  height: '35px',
                  borderRadius: '5px',
