...
<div className="home" style={{display:'flex',flexDirection:'row'}}>
    <div className="card border mt-3" style={{width: '10rem'}}>
  <img src="https://rukminim1.flixcart.com/image/200/200/l5ld8y80/monitor/l/k/s/-original-imagg897ufhyvwqq.jpeg?q=70" className="card-img-top" alt="..."/>
  <div className="card-body " style={{textAlign:'center'}}>
    <span className="card-text font-weight-bold">Monitors</span><br/>
    <span className='text-success'>From <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-currency-rupee" viewBox="0 0 16 16">
  <path d="M4 3.06h2.726c1.22 0 2.12.575 2.325 1.724H4v1.051h5.051C8.855 7.001 8 7.558 6.788 7.558H4v1.317L8.437 14h2.11L6.095 8.884h.855c2.316-.018 3.465-1.476 3.688-3.049H12V4.784h-1.345c-.08-.778-.357-1.335-.793-1.732H12V2H4v1.06Z"/>
</svg>9999</span><br/>
    <span className='text-secondary'>SAMSUNG</span>
  </div>
</div>
<div className="card ml-2 mt-1" style={{width: '10rem'}}>
  ...
  <div className="card-body " style={{textAlign:'center'}}><br/>
    <span className="card-text font-weight-bold " >City & MTB Cycle</span><br/>
...
<div className="card ml-2 mt-1" style={{width: '10rem'}}>
  ...
  <div className="card-body" style={{textAlign:'center'}}>
  <span className="card-text font-weight-bold">Gym Essentails</span><br/>
...
<div className="card ml-2 mt-1" style={{width: '10rem'}}>
  ...
  <div className="card-body" style={{textAlign:'center'}}>
  <span className="card-text font-weight-bold">Mattress Protectors</span><br/>
    <span className='text-success'>From <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-currency-rupee" viewBox="0 0 16 16">
  <path d="M4 3.06h2.726c1.22 0 2.12.575 2.325 1.724H4v1.051h5.051C8.855 7.001 8 7.558 6.788 7.558H4v1.317L8.437 14h2.11L6.095 8.884h.855c2.316-.018 3.465-1.476 3.688-3.049H12V4.784h-1.345c-.08-.778-.357-1.335-.793-1.732H12V2H4v1.06Z"/>
</svg>149</span><br/>
